...
{
    [Table("FireP15_BazdidSpecialGroupOver30", Schema = "fr")]
    public partial class FireP15BazdidSpecialGroupOver30
    {
        public int Id { get; set; }
        public int? EzafiId { get; set; }
        ...
        public string RiskTabagh { get; set; }
